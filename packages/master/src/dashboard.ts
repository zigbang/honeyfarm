    ...
    Object.entries(data).filter(([key, value]) => {
        if(value.platform === "android") {
            ...
            <div class="view_container">
                ...
                <iframe height="800px" width="550px" src="http://${node_address.ip}:${node_address.port}/#!action=stream&udid=${value.udid}&decoder=broadway&ip=${node_address.ip}&port=${node_address.port}&query=%3Faction%3Dproxy%26remote%3Dtcp%253A8886%26udid%3D${value.udid}" frameBorder="0"></iframe>
            </div>
            `
