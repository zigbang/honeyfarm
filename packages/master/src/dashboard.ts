...
export async function html_editor() {
    ...
    let node_ip = "localhost:8000"
    // let node_ip = "192.168.99.37:8000" 
    ...
    Object.entries(data).filter(([key, value]) => {
        if(value.platform === "android") {
            ...
            <div class="view_container">
                ...
                <iframe height="800px" width="550px" src="http://${node_ip}/#!action=stream&udid=${value.udid}&decoder=broadway&ip=192.168.99.37&port=8000&query=%3Faction%3Dproxy%26remote%3Dtcp%253A8886%26udid%3D${value.udid}" frameBorder="0"></iframe>
            </div>
            `
